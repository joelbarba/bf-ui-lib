...
describe('BfArray', () => {
  ...
  describe('removeDuplicates', () => {
    it('should remove primitive duplicates', () => {
      ...
      BfArray.removeDuplicates.call(arr3);
    ...
    it('should remove object duplicates', () => {
      ...
      BfArray.removeDuplicates.call(arr);
    ...
    it('should compare using a custom function', () => {
      ...
      BfArray.removeDuplicates.call(arr, (itemA, itemB) => itemA.id === itemB.id);
      expect(arr).toEqual([
        { id: 1, age: 10 },
        { id: 2, age: 10 },
        { id: 3, age: 20 },
      ...
      BfArray.removeDuplicates.call(arr2, (itemA, itemB) => itemA.age === itemB.age);
      expect(arr2).toEqual([
        { id: 1, age: 10 },
        { id: 3, age: 20 },
        { id: 1, age: 30 },
