...
export class BfColorPickerDemoComponent implements OnInit {
  ...
  public brStr = `\n`;
  public bsStr = `\n             `;
  public customCompCode = `<bf-color-picker [bfColor]="color" (bfColorChange)="onColorChanged($event)"></bf-color-picker>`;
  public compConf: any = {
    color: '731573'
  };
  public upComp = () => {
    ...
    this.customCompCode += `(bfColor)="myVal"` + this.bsStr;
    this.customCompCode += `(bfColorChange)="doSomething($event)"`;
...
(bfColorChange): An event emitted when the color has changed`,
  instance: `<bf-color-picker bfColor="731573" (bfColorChange)="onColorChanged($event)"></bf-color-picker>`,
