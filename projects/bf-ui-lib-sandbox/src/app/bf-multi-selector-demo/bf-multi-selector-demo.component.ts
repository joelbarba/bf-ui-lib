...
import { IbfDropdownCtrl } from 'projects/bf-ui-lib/src/lib/bf-dropdown/bf-dropdown.component';
...
$dropdown-valid-color: $valid-color !default;`;
  ...
  public extCtrlExample1 = `<bf-multi-selector .... (bfOnLoaded)="myCtrl = $event"></bf-multi-selector>
...
myCtrl.removeError()`;
  ...
  public extCtrlExample2 = `<bf-multi-selector .... [extCtrl$]="extCtrl$"></bf-multi-selector>
...
`;
  ...
  public upComp = () => {
    ...
    this.code += (`>` + this.brStr + `</bf-multi-selector>`);
...
(bfOnTyping)         : Emitter to catch when typing into the input`,
  instance: `<bf-multi-selector [(ngModel)]="selObj" [bfList]="myList"></bf-multi-selector>`,
