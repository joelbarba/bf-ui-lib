...
@Component({
  selector: 'app-bf-list-handler-test',
  templateUrl: './bf-list-handler-test.component.html'
})
export class BfListHandlerTestComponent implements OnInit, OnDestroy {
  public listData = [
  ...
  constructor() {
    ...
    this.testList1 = new BfListHandler({
